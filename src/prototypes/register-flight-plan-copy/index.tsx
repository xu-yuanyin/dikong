...
import { RocketOutlined, CheckCircleOutlined, EnvironmentOutlined, ClockCircleOutlined, CalendarOutlined, SafetyCertificateOutlined, PlusOutlined, FileTextOutlined, ExclamationCircleOutlined } from '@ant-design/icons';
    ...
    <div style={{ minHeight: '100vh', background: '#f5f5f5' }}>
      ...
      >
        <div style={{ textAlign: 'center', padding: '24px 0' }}>
          ...
          <Button type="primary" size="large" block onClick={function () { setShowSuccess(false); window.location.href = '/prototypes/profile-certified?tab=plan'; }}>
            查看我的飞行计划
          </Button>
        </div>
      </Modal>
