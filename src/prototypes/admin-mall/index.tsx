...
var GOODS_DATA = [
  { key: '1', id: 'MALL-2026-101', title: '大疆 DJI Mavic 3 Enterprise', category: '无人机整机', price: '¥22,000.00', provider: 'XX无人机专营店', time: '2026-04-18 10:00', status: 'normal' },
  { key: '2', id: 'MALL-2026-102', title: '纵横 CW-15 垂直起降固定翼', category: '无人机整机', price: '电议', provider: '纵横官方旗舰店', time: '2026-04-19 14:30', status: 'normal' },
  { key: '3', id: 'MALL-2026-103', title: '特价三无电池', category: '核心零部件', price: '¥500.00', provider: '某个人商户', time: '2026-04-20 08:15', status: 'offline' }
];
...
var Component = function AdminMallPage() {
  ...
  var handleTakedown = function () {
    message.success('已强制下架该商品，前台大厅将不再展示');
  ...
  return (
    <AdminLayout activeKey="admin-mall">
      ...
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: 24 }}>
        ...
        <Card style={{ borderRadius: 12 }}>
          <div style={{ display: 'flex', gap: 12, marginBottom: 16, flexWrap: 'wrap' }}>
            ...
            <Select placeholder="分类" style={{ width: 140 }} options={[{ value: '1', label: '无人机整机' }, { value: '2', label: '核心零部件' }]} allowClear />
      ...
      <Modal
        title={<span style={{ color: '#ff4d4f' }}>强制下架该商品</span>}
        open={takedownOpen}
        ...
        okText="确认下架"
      >
        <div style={{ marginBottom: 16, fontSize: 14 }}>您正在强制下架商品 <strong>{currentRecord?.title}</strong>，下架后将不在商城大厅展示。</div>
        <Input.TextArea 
