...
import { UserOutlined, SafetyCertificateOutlined, ClockCircleOutlined, CheckCircleOutlined } from '@ant-design/icons';
...
var Component = function ProfilePendingPage() {
        ...
        <div style={{ display: 'flex', gap: 24 }}>
          <Card style={{ borderRadius: 12, width: 240, flexShrink: 0 }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '16px 0' }}>
              ...
              <Tag color="orange" icon={<ClockCircleOutlined />}>审核中</Tag>
            </div>
          </Card>
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            <Card title="认证信息" style={{ borderRadius: 12 }}>
              <Alert
                ...
                message="您的认证申请正在审核中"
                description="审核通常需要 1-3 个工作日，请耐心等待。审核结果将通过短信和站内消息通知您。"
                style={{ marginBottom: 16 }}
              />
              <Descriptions column={2} bordered>
                <Descriptions.Item label="认证状态"><Tag color="orange">审核中</Tag></Descriptions.Item>
            ...
            <Card title="认证进度" style={{ borderRadius: 12 }}>
              <Steps
                ...
                items={[
                  ...
                  { title: '资料审核中', description: '工作人员正在审核您的认证资料，请耐心等待', status: 'process', icon: <ClockCircleOutlined /> },
                  { title: '审核完成', description: '审核通过后将获得对应角色权限', status: 'wait' }
                ]}
                style={{ padding: '8px 0' }}
              />
            </Card>
