...
__export(index_exports, {
  ...
  GenieBrandButton: () => GenieBrandButton,
  ProtoDevPanel: () => ProtoDevPanel,
  buildAnnotationPrompt: () => buildAnnotationPrompt,
  createAnnotationViewer: () => createAnnotationViewer,
  createProtoDevController: () => createProtoDevController,
  defineProtoDevControls: () => registerProtoDevControls,
  getProtoDevState: () => getProtoDevState,
  parseAnnotationMarkdownRecords: () => parseAnnotationMarkdownRecords,
  parseAnnotationsMarkdown: () => parseAnnotationsMarkdown,
  serializeAnnotationsMarkdown: () => serializeAnnotationsMarkdown,
  setProtoDevState: () => setProtoDevState,
  subscribeProtoDevState: () => subscribeProtoDevState,
  useProtoDevState: () => useProtoDevState
});
...
function CloseToolIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SvgIcon, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M4.5 4.5l7 7" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M11.5 4.5l-7 7" })
  ] });
}
function TooltipButton(props) {
  const { title, children, disabled } = props;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Tooltip, { title, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { display: "inline-flex" }, children: import_react.default.cloneElement(children, { disabled }) }) });
}
function IconActionButton(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipButton, { title, disabled, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_antd.Button,
    {
      size: "small",
      type: "text",
      "aria-label": title,
      icon: loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.LoadingOutlined, { spin: true }) : icon,
      disabled,
      onClick,
